...
export default function HeaderTwo() {
  ...
  return (
    <div className="techfee-header-area mb-80 z-index-5">
                  ...
                  <nav className="bastami-main-menu main_menu_2">
                    <ul style={{ display: "flex", alignItems: "center" }}>
                      <li className={pathname == "/home-2" ? "active" : ""}>
                        <Link href="/home-2" style={{ display: "flex", alignItems: "center" }}>
                          <span>
                            <Image width={20} height={20} src="/assets/img/icon/home.png" alt="icon" />
                          </span>
                          home
                        </Link>
                      </li>
                      ...
                      {menuItemsTwo.map((elm, i) => (
                        <li key={i} className={pathname == elm.href ? "active" : ""}>
                          <Link href={elm.href} style={{ display: "flex", alignItems: "center" }}>
