...
export default function ContactForm() {
  ...
  return (
    <form className="contact-form" ref={form} onSubmit={sendEmail}>
      ...
      <div className="form-input-item mb-60">
        <label
          style={activeInputBoxes.includes("gmail") ? { color: "#66B200" } : {}}
        ...
        <input
          ...
          style={activeInputBoxes.includes("gmail") ? { borderColor: "#66B200" } : {}}
        />
      </div>
      <div className="form-input-item mb-40">
        <label
          style={activeInputBoxes.includes("message") ? { color: "#CE65F3" } : {}}
