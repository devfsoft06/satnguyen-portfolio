          ...
          <div className="bostami-resume-2">
            <div className="row">
              <div className="col-xl-4 col-lg-6 col-md-6">
                <div className="bostami-section-title-wrap mb-20">
                  <h4 className="section-title">
                    <Image width={38} height={23} src="/assets/img/icon/edu-icon-2.png" alt="education" />
                    Education
                  </h4>
                </div>
              ...
              <div className="col-xl-4 col-lg-6 col-md-6">
                <div className="bostami-section-title-wrap mb-20">
                  <h4 className="section-title">
                    <Image width={30} height={27} src="/assets/img/icon/exper-icon-2.png" alt="experience" />
                    experience
                  </h4>
                </div>
              ...
              <div className="col-xl-4 col-lg-6 col-md-6">
                <div className="bostami-section-title-wrap mb-20">
                  <h4 className="section-title">
                    <Image width={24} height={31} src="/assets/img/icon//Awards-icon.png" alt="awards" />{" "}
                    Awards
                  </h4>
                </div>
            ...
            <div className="row">
              <div className="col-xl-6 col-lg-7">
                ...
                <div className="skill-bar-wrap">
                  {skillData.map((elm, i) => (
                    <div key={i} className={`skill-bar-item ${i + 1 != skillData.length && "mb-30"} `}>
